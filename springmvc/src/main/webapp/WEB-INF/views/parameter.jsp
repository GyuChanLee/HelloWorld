...
<body>
    ...
    <div>
        <input name="list[3].id">
        <input type="checkbox" name="list[3].ids" value="100">100
        <input type="checkbox" name="list[3].ids" value="101">101
        <input type="checkbox" name="list[3].ids" value="102">102    
    </div>
    ...
    <form action="req6" method="post" enctype="multipart/form-data">
        ...
        <input type="checkbox" name="ids" value="101">101
        <input type="checkbox" name="ids" value="102">102
        <input type="file" name="pic">파일
        <button>파일업로드</button>
    </form>
    
    <a href="req7/lee/20">pathvariable</a>
